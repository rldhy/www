...
tags: ['ai', 'rag', 'local-ai', 'ollama', 'langchain', 'embeddings', 'vector-database', 'vector-search', 'similarity-search', 'legal-tech', 'python', 'docker', 'chroma', 'gemma', 'gemma-3-12b', 'nomic', 'nomic-embed-text-v1']
draft: false
