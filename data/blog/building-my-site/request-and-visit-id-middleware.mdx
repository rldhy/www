...
draft: false
summary: 'How I used Next.js proxy middleware to add per-request IDs, week-long visit IDs, and a composable middleware context'
images: []
---
...
- `visitId`: stable for a visitor across page loads for a short period
