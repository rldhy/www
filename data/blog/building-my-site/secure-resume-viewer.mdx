---
title: 'Building a Secure PDF Résumé Viewer with Next.js & hCaptcha'
date: '2025-08-07'
lastModified: '2025-08-14
tags: [next-js, pdf, resume, hcaptcha, react-pdf]
draft: false
summary: 'How I created a protected résumé viewer with Next.js, in-memory caching, and bot protection using hCaptcha'
images: []
---
...
You can view the final page [here](/resume) — assuming you’re human enough to pass the captcha 🧠
