    ...
    <>
      <div className="my-6 flex flex-col items-center gap-x-12 xl:mb-12 xl:flex-row">
        <div className="w-full pt-6">
          ...
          <div className="flex flex-col items-center gap-y-2 pt-8 xl:flex-row xl:gap-x-2 xl:gap-y-0">
            <Image
              src="/static/images/avatar.png"
              alt="Ritwik Lodhiya"
              width={192}
              height={192}
              className="flex rounded-4xl pb-4 xl:mr-4"
            />
            <div className="prose flex flex-col text-lg text-gray-600 dark:text-gray-300">
              <span className="mb-2">
